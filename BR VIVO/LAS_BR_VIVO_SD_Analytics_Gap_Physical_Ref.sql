// Standard Dashboard - BR VIVO Report - Analytics - Gap Analysis Physical
create or replace view LAS_BR_VIVO_SD_ANALYTICS_PHYSICAL_GAP as (
    select 
    ...
    ) as LAS_BR_VIVO_SD_ANALYTICS_PHYSICAL_PIVOT
);

// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

select * from LAS_BR_VIVO_SD_ANALYTICS_PHYSICAL_GAP;
