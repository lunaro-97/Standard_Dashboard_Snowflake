// Standard Dashboard - UY ANTEL Report - Analytics - Lead Time

create or replace view LAS_UY_ANTEL_SD_ANALYTICS_LT as (

    with LAS_UY_ANTEL_SD_ANALYTICS_LOGICAL_REF as (
    ...
    , LAS_UY_ANTEL_SD_PMO_ANALYTICS_LOGICAL_PIVOT_MAIN as(
    select 
    ...
    from LAS_UY_ANTEL_SD_ANALYTICS_LOGICAL_REF
    ...
    pivot (
        ...
        ) as LAS_UY_ANTEL_SD_ANALYTICS_PIVOT
        
    )
    , LAS_UY_ANTEL_SD_PMO_ANALYTICS_LT_CALC as (
        select
        ...
        from LAS_UY_ANTEL_SD_PMO_ANALYTICS_LOGICAL_PIVOT_MAIN
    )

    , LAS_UY_ANTEL_SD_PMO_ANALYTICS_LT_PIVOT as(
        select
        ...
        "LT Categories",
        "LT"
        from LAS_UY_ANTEL_SD_PMO_ANALYTICS_LT_CALC
        ...
        ) as LAS_UY_ANTEL_SD_PMO_ANALYTICS_LT_UNPIVOT
    )
    ...
    from LAS_UY_ANTEL_SD_PMO_ANALYTICS_LT_PIVOT LT_PVT
    left join LAS_UY_ANTEL_SD_LOGICAL_REF LOG_T
    on LT_PVT."ID" = LOG_T."Project ID" and "LT Category 1" = LOG_T."Milestones"
    left join LAS_UY_ANTEL_SD_LOGICAL_REF ASP02RREF
    on LT_PVT."ID" = ASP02RREF."Project ID" and "LT Category 2" = ASP02RREF."Milestones"
);

// -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

select * from LAS_UY_ANTEL_SD_ANALYTICS_LT;
