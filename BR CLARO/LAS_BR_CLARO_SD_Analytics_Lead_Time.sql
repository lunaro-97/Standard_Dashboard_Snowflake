// Standard Dashboard - BR CLARO Report - Analytics - Lead Time
create or replace view LAS_BR_CLARO_SD_ANALYTICS_LT as (

    with LAS_BR_CLARO_SD_ANALYTICS_LOGICAL_REF as (
    ...
    , LAS_BR_CLARO_SD_PMO_ANALYTICS_LOGICAL_PIVOT_MAIN as(
    select 
        """Tools""" "Tools",
        """Scope""" "Scope",
    ...
    from LAS_BR_CLARO_SD_ANALYTICS_LOGICAL_REF
    ...
    pivot (
        ...
        ) as LAS_BR_CLARO_SD_ANALYTICS_PIVOT
        
    )
    , LAS_BR_CLARO_SD_PMO_ANALYTICS_LT_CALC as (
        select
        ...
        from LAS_BR_CLARO_SD_PMO_ANALYTICS_LOGICAL_PIVOT_MAIN
    )

    , LAS_BR_CLARO_SD_PMO_ANALYTICS_LT_PIVOT as(
        select
        ...
        "LT Categories",
        "LT"
        from LAS_BR_CLARO_SD_PMO_ANALYTICS_LT_CALC
        ...
        ) as LAS_BR_CLARO_SD_PMO_ANALYTICS_LT_UNPIVOT
    )
    ...
    from LAS_BR_CLARO_SD_PMO_ANALYTICS_LT_PIVOT LT_PVT
    left join LAS_BR_CLARO_SD_LOGICAL_REF LOG_T
...
select * from LAS_BR_CLARO_SD_ANALYTICS_LT;
